...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sprinkler.authorized'
        db.add_column(u'sprinkler_sprinkler', 'authorized',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sprinkler.authorized'
        db.delete_column(u'sprinkler_sprinkler', 'authorized')
