...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Squirt.messageType'
        db.delete_column(u'sprinkler_squirt', 'messageType')


    def backwards(self, orm):
        # Adding field 'Squirt.messageType'
        db.add_column(u'sprinkler_squirt', 'messageType',
