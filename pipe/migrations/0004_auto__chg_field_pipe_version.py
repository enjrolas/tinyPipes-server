...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pipe.version'
        db.alter_column(u'pipe_pipe', 'version', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Pipe.version'
        db.alter_column(u'pipe_pipe', 'version', self.gf('django.db.models.fields.TextField')())
