...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pipe_pipe', (
            ...
            ('serialNumber', self.gf('django.db.models.fields.TextField')()),
            ('version', self.gf('django.db.models.fields.TextField')(default='v2.3', null=True, blank=True)),
            ('phoneNumber', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
