...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Squirt.phoneNumber'
        db.add_column(u'communications_squirt', 'phoneNumber',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Spray.phoneNumber'
        db.add_column(u'communications_spray', 'phoneNumber',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Squirt.phoneNumber'
        db.delete_column(u'communications_squirt', 'phoneNumber')

        # Deleting field 'Spray.phoneNumber'
        db.delete_column(u'communications_spray', 'phoneNumber')
