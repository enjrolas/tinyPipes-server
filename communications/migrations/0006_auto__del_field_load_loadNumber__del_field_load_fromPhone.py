...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Load.loadNumber'
        db.delete_column(u'communications_load', 'loadNumber')

        # Deleting field 'Load.fromPhone'
        db.delete_column(u'communications_load', 'fromPhone')


    def backwards(self, orm):
        # Adding field 'Load.loadNumber'
        db.add_column(u'communications_load', 'loadNumber',
                      self.gf('django.db.models.fields.TextField')(default='214'),
                      keep_default=False)

        # Adding field 'Load.fromPhone'
        db.add_column(u'communications_load', 'fromPhone',
